...
public class RssDataParser {
    ...
    protected ArrayList parse(InputStream inputStream) throws XmlPullParserException, IOException {
        try {
            ...
            //google built an implementation for android to pull apart xml data.. creating XmlPullParser and Xml class
    ...
    public static class Item {
        //nested class that will take in information from the xml feed (title, link, descr, publication date) and will attach that to an Item added to an arraylist
